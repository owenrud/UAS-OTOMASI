...
WebUI.setText(findTestObject('Object Repository/Page_/input_ID User_id_user'), id)

WebUI.setText(findTestObject('Object Repository/Page_/input_Nama Petani_nama_petani'), nama)

WebUI.setText(findTestObject('Page_/input_Tanggal Lahir_tanggal_lahir'), '06/06/2023')

WebUI.setText(findTestObject('Page_/input_Nama Istri  Suami_nama_istri'), nama_istri)

WebUI.setText(findTestObject('Object Repository/Page_/input_Alamat Petani_alamat_petani'), alamat)
...
WebUI.setText(findTestObject('Object Repository/Page_/input_Nomor Telepon_nomor_telpon'), no_telp)

WebUI.selectOptionByValue(findTestObject('Object Repository/Page_/select_SD                                  _d31312'), 
    'S2', true)

WebUI.setText(findTestObject('Object Repository/Page_/input_Jumlah Lahan_jml_lahan'), lahan)

WebUI.setText(findTestObject('Object Repository/Page_/input_Jumlah Tanggungan_jumlah_tanggungan'), tanggungan)

WebUI.setText(findTestObject('Object Repository/Page_/input_Jumlah Tenaga Kerja Musiman_jml_tng_k_49b205'), tng_kerja)
...
WebUI.setText(findTestObject('Object Repository/Page_/textarea_Deskripsi Keahlian_deskripsi_keahlian'), desc)
